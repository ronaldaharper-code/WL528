...
// Render at request time only — never prerender
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex items-center gap-2 text-sm text-stone-500">
            <li>
              <Link href="/events" className="hover:text-navy-700">
                Events
              </Link>
            </li>
        ...
        <div className="flex flex-wrap gap-4 pt-6 border-t border-stone-200">
          <a href={`/api/events/${event._id}/ics`} className="btn-secondary text-sm">
            Add to Calendar (.ics)
          </a>
